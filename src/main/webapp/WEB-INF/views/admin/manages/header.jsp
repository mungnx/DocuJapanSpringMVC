...
<html>
    <head>
        ...
        <link href="<c:url value="/assets/admin/css/bootstrap.css"/>" rel='stylesheet' type='text/css'/>
        <!-- Custom Theme files -->
        ...
        <!--icons-css-->
        <link href="<c:url value="/assets/admin/css/font-awesome.css"/>" rel="stylesheet" type="text/css"/> 
        <!--Google Fonts-->
        ...
        <!--//charts-->
        <!-- geo chart -->
        <script src="<c:url value="/assets/admin/js/modernizr.min.js" />" type="text/javascript"></script>
        ...
        <script src="<c:url value="/assets/admin/js/skycons.js" />" type="text/javascript"></script>
        <script src="<c:url value="/assets/admin/js/jquery.nicescroll.js" />"></script>
        <script src="<c:url value="/assets/admin/js/scripts.js" />" type="text/javascript"></script>
