...
<body>	
	...
	<div class="row">
				<span style="margin-left: 25px;">Danh sach  ${categoryById.name}</span>
			<select
				class="pull-right">
				<option>A-Z</option>
				<option>Price</option>
		...
		<c:if test="${productsByPaginate.size()>0 }">
	...
	<c:forEach var="item" begin="1" end="${paginateInfo.toltalPage }" varStatus="loop">
